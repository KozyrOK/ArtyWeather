const messages = {
    en: {
        ...
        dashboard: 'Dashboard', weatherOverview: 'Weather overview', currentWeather: 'Current weather', refreshWeather: 'Refresh weather', loadingWeather: 'Loading weather…', emptyWeather: 'No weather data available.',
     ...
     ru: {
        ...
        dashboard: 'Настройки', weatherOverview: 'Обзор погоды', currentWeather: 'Текущая погода', refreshWeather: 'Обновить погоду', loadingWeather: 'Загружаем погоду…', emptyWeather: 'Нет данных о погоде.',
        ...
        forecast: 'Прогноз', charts: 'Графики погоды', time: 'Время', noForecast: 'Нет данных прогноза.', temperature: 'Температура', apparentTemperature: 'Ощущается как', relativeHumidity: 'Влажность', precipitation: 'Осадки', weatherCode: 'Код погоды', cloudCover: 'Облачность', pressure: 'Давление', windSpeed: 'Скорость ветра', windDirection: 'Направление ветра', windGusts: 'Порывы ветра', weatherCondition: 'Состояние погоды', coordinates: 'Координаты', recommendation: 'Рекомендация', summary: 'Описание',
    ...
    uk: {
        ...
        dashboard: 'Налаштування', weatherOverview: 'Огляд погоди', currentWeather: 'Поточна погода', refreshWeather: 'Оновити погоду', loadingWeather: 'Завантажуємо погоду…', emptyWeather: 'Немає даних про погоду.',
